...
def save_mail(mail: List[Dict[str, str]]) -> None:
    """
    Summary: Saves the mail to the json file
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """
    Summary: Adds a mail entry to the json file

    Args:
        mail_entry (dict): A dictionary representing a mail entry

    Returns:
        str: The unique id assigned to the mail entry
    """
    mail = load_mail()
...
def delete_mail(mail_id: str) -> bool:
    ...
    Args: 
        mail_id (str): The unique id of to the mail entry to delete

    Returns:
        bool: True if the mail entry was deleted, False otherwise
    """
    mail = load_mail()
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """
    Summary: Gets all mail entries from a given recipient

    Args:
        recipient (str): The recipient whose inbox is requested
    
    Returns:
        list: A list of dictionaries representing the recipient's mail entries
    """
    mail = load_mail()
    inbox = []
    for entry in mail:
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """
    Summary: Gets all mail entries sent by a given sender

    Args:
        sender (str): The sender whose sent mail is requested

    Returns:
        list: A list of dictionaries representing the sender's sent email entries
    """
    mail = load_mail()
    sent = []
    for entry in mail:
